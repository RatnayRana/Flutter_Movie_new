...
final List<MovieModel> MOVIES_CONSTANT = [
  ...
  MovieModel(
      ...
      img:
          "https://cdn.pixabay.com/photo/2020/04/20/18/10/cinema-5069314_640.jpg",
      rating: 6.1,
      year: 2024,
      genres: ["Drama"],
      runtime: 0),
  MovieModel(
      ...
      img:
          "https://cdn.pixabay.com/photo/2019/10/17/21/17/joker-4557864_640.jpg",
      rating: 7.2,
      year: 2019,
  ...
  MovieModel(
      ...
      img:
          "https://cdn.pixabay.com/photo/2020/06/29/21/13/city-5354477_640.jpg",
      rating: 5.2,
      year: 2024,
      genres: ["Horror"],
      runtime: 0),
  MovieModel(
      ...
      img:
          "https://cdn.pixabay.com/photo/2017/03/07/23/33/technology-2125547_640.jpg",
      rating: 6.2,
      year: 1960,
      genres: ["Documentary"],
      runtime: 25),
  ...
  MovieModel(
      ...
      title: "Cold Steel",
      description:
          "On Christmas Eve Johnny Modine's father is murdered by a psycho cut-throat. The cop swears bloody revenge, though he's taken off the case. He doesn't suspect yet that he's also target in a diabolic plan of revenge.—Tom Zoerner",
  ...
  MovieModel(
    ...
    title: "Single8",
    description:
        "During the midst of Star Wars fever in the late 1970s, a cinephile high schooler teams up with three classmates to make his no-budget sci-fi masterpiece for a class project.",
    img:
        "https://cdn.pixabay.com/photo/2023/06/19/18/41/blue-jay-8075346_640.jpg",
    rating: 7.2,
    year: 2023,
  ...
  MovieModel(
    ...
    img:
        "https://cdn.pixabay.com/photo/2023/04/05/16/08/hedgehog-fly-7901862_640.jpg",
    rating: 7.6,
    year: 1999,
    genres: ["Drama"],
    runtime: 91,
